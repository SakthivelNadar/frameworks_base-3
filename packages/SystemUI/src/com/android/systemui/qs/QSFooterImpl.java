...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    private void updateBrightnessResources() {
        if (mBrightnessMirrorController != null) {
            ToggleSliderView brightnessSlider = findViewById(R.id.brightness_slider);
            ToggleSliderView mirrorSlider = mBrightnessMirrorController.getMirror()
                    .findViewById(R.id.brightness_slider);
            int footerPadding = getResources().getDimensionPixelOffset(R.dimen.qs_footer_padding);
            if (mQsPanel.shouldUseHorizontalLayout()) {
                View brightnessView = (View) brightnessSlider.getParent();
                View mirrorView = (View) mirrorSlider.getParent();
                brightnessView.setPadding(0, brightnessView.getPaddingTop(), 0, brightnessView.getPaddingBottom());
                mirrorView.setPadding(0, mirrorView.getPaddingTop(), 0, mirrorView.getPaddingBottom());
                footerPadding = 0;
            }
            if (brightnessSlider != null) {
                brightnessSlider.setPadding(footerPadding, brightnessSlider.getPaddingTop(), footerPadding, brightnessSlider.getPaddingBottom());
            }
            if (mirrorSlider != null) {
                mirrorSlider.setPadding(footerPadding, mirrorSlider.getPaddingTop(), footerPadding, mirrorSlider.getPaddingBottom());
            }
        }
    }
